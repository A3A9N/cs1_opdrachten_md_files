...
namespace FunctionOpdracht5
{
    internal class Program
    {
        ...
        //5) maak deze function, je mag een random gebruiken of een vast getal
        private int RollDamage()
        {
            Random random = new Random();
            return random.Next(1, 100); // Random damage between 1 and 100
        }

        //6) maak deze function, deze haalt dam af van de health (op program)
